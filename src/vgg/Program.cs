...
// 数据集来源请参考 https://torch.whuanle.cn/03.image/dcgan_faces_tutorial.html#%E6%95%B0%E6%8D%AE%E9%9B%86%E5%A4%84%E7%90%86
...
for (int epoch = 0; epoch < options.NumEpochs; epoch++)
{
    foreach (var item in dataloader)
    {
        ...
        if (i % 100 == 0)
        {
            ...
            fake.detach().SaveJpeg($"samples/fake_samples_epoch_{epoch:D3}_{i}.jpg");
        }
